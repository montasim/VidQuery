...
Open `v1.html` in a browser with an internet connection. Tailwind loads from its CDN, while the embedded product demo loads from `../extension/v1.html`.

The page includes:

- responsive desktop and mobile navigation;
- direct links to the latest Chrome ZIP and release checksums;
